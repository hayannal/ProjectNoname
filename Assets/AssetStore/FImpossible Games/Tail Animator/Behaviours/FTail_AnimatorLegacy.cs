...
namespace FIMSpace.FTail
{
    ...
    /// </summary>
    [AddComponentMenu("FImpossible Games/Tail Animator/Utilities/FTail Animator Legacy")]
    public class FTail_AnimatorLegacy : FTail_Animator
    {
        ...
        protected override void Init()
        {
            ...
            {
                proceduralPoints[i].Position = previousSkinnedBones[i].position;
                proceduralPoints[i].Rotation = previousSkinnedBones[i].rotation;
            }
            ...
            firstBoneInitialRotation = Vector3.zero;
        ...
        protected override void MotionCalculations()
        {
            ...
            proceduralPoints[0].Position = previousSkinnedBones[0].position;
