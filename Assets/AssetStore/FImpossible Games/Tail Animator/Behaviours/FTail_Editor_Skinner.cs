...
namespace FIMSpace.FTail
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu("FImpossible Games/Tail Animator/Utilities/FTail Editor Skinner")]
    public class FTail_Editor_Skinner : MonoBehaviour
    {
        ...
        private void UpdatePreviewMesh()
        {
            ...
            if (weightPreviewTransform == null)
            {
                ...
                for (int i = 0; i < newMaterials.Length; i++) newMaterials[i] = new Material(Shader.Find("Particles/VertexLit Blended"));
        ...
        private void CalculateAutoMarkers()
        {
            ...
            autoMarkers[0].rotation = Quaternion.Euler(startDirection);
            ...
            for (int i = 1; i < AutoMarkersCount; i++)
            {
                ...
                Vector3 newRot = startDirection + rotationOffset * i * RotationsFaloff.Evaluate(i * step);
        ...
        public void SkinMesh(bool addTailAnimator = false)
        {
            ...
            if (addTailAnimator) bones[0].gameObject.AddComponent<FTail_Animator>();
        ...
        public class VertexData
        {
            ...
            /// </summary>
            public void CalculateVertexParameters(Transform[] allSkinnedBones, int maxWeightedBones, float spread, float forward)
            {
                ...
                for (int i = 0; i < allSkinnedBones.Length; i++)
                {
                    ...
                    calculatedDistances.Add(new Vector2(i, Vector3.Distance(position, allSkinnedBones[i].localPosition + allSkinnedBones[i].TransformDirection(forwDir) * forward)));
                }
